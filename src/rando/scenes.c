...
/*scenes*/
static rando_scene_t SM_scenes[2] = {
    { "spiral mountain",
        0x01, 2,
        (rando_entrance_t[]){
...
static rando_scene_t MM_scenes[3] = {
    { "mumbo's mountain",
        0x02, 5,
        (rando_entrance_t[]){
...
static rando_scene_t TTC_scenes[5] = {
    { "treasure trove cove",
        0x07, 11,
        (rando_entrance_t[]){
...
static rando_scene_t CC_scenes[4] = {
    { "clanker's cavern",
        0x0B, 5,
        (rando_entrance_t[]){
...
static rando_scene_t BGS_scenes[4] = {
    { "bubblegloop swamp",
        0x0D, 6,
        (rando_entrance_t[]){
...
static rando_scene_t FP_scenes[5] = {
    { "freezeezy peak",
        0x27, 7,
        (rando_entrance_t[]){
...
static rando_scene_t GV_scenes[7] = {
    { "gobi's valley",
        0x12, 8,
        (rando_entrance_t[]){
...
static rando_scene_t MMM_scenes[16] = {
    { "mad monster mansion",
        0x1B, 18,
        (rando_entrance_t[]){
...
static rando_scene_t RBB_scenes[14] = {
    { "rusty bucket bay",
        0x31, 15,
        (rando_entrance_t[]){
...
static rando_scene_t CCW_hub_scene[1] = {
    { "season hub",
        0x40, 5,
        (rando_entrance_t[]){
...
static rando_scene_t CCW_spring_scenes[5] = {
...
static rando_scene_t CCW_summer_scenes[5] = {
...
static rando_scene_t CCW_autumn_scenes[6] = {
...
static rando_scene_t CCW_winter_scenes[6] = {
...
static rando_scene_t lair_scenes[21] = {
...
static rando_scene_t title_cutscenes[2] = {
    { "start - nintendo",
        0x1E, 1,
        (rando_entrance_t[]){
            {0x0, ""},
...
static rando_scene_t intro_cutscenes[10] = {
    { "(Intro) Spiral A",
        0x7D, 1,
        (rando_entrance_t[]){
            {0x0, ""},
...
static rando_scene_t lair_cutscene[1] = {
...
static rando_scene_t gameover_cutscene[1] = {
    { "game over",
        0x83, 1,
        (rando_entrance_t[]){
            {0x0, ""},
...
static rando_scene_t end_cutscenes[7] = {
    { "end - not 100%%",
        0x20, 1,
        (rando_entrance_t[]){
            {0x0, ""},
...
static rando_scene_t file_select_scene[1] = {
    { "",
        0x91, 1,
        (rando_entrance_t[]){
            {0x1, ""},
...
/*sub categories*/
static rando_scene_category_t CCW_categories[5] = {
...
static rando_scene_category_t cutscene_categories[5] = {
...
/*main categories*/
rando_scene_category_t scene_categories[] = {
